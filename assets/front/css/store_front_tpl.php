    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col--md-4 col-sm-4 col-xs-4">
                ...
                <img src="<?php echo Yii::app()->request->baseUrl;?>/assets/front/img/ad/logo.png" width="59" height="23" alt="" data-retina="true" class="hidden-lg hidden-md hidden-sm">
                </a>
            </div>
...
<!--                    <li><a href="<?php //echo Yii::app()->createUrl($signup_link); ?>">Restaurant Signup</a></li>-->
                    
                    
                    <?php if ( !Yii::app()->functions->isClientLogin()): ?>
                    <li class="top_front_sigin"><a href="#0" data-toggle="modal" data-target="#login_2">Customer Login</a></li>
                    <?php endif;?>
                    
                   <li class="submenu front-user-display" style="<?php if ( !Yii::app()->functions->isClientLogin()): echo "display: none";endif;?>">
                    <a href="javascript:void(0);" class="show-submenu"> Dashboard<?php //echo ucwords(Yii::app()->functions->getClientName());?><i class="icon-down-open-mini"></i></a>
                        <ul>
                            <li>
...
<!--                <li><a href="<?php echo Yii::app()->createUrl('store/faq'); ?>">Faq</a></li>-->
                <li><a href="<?php echo Yii::app()->createUrl('store/contact'); ?>">Contact Us</a></li>
                 <?php if ( !Yii::app()->functions->isClientLogin()):?>
                <li class="top_front_sigin"><a href="#0" data-toggle="modal" data-target="#login_2">Customer Login</a></li>
                <li class="top_front_signup"><a href="#0" data-toggle="modal" data-target="#register">Customer Register</a></li>
                <?php endif;?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="social_footer">
                    <ul>
                        <li><a href="https://www.facebook.com/bhukkasofficial?_rdr=p"><i class="icon-facebook"></i></a></li>
                        <li><a href="https://twitter.com/bhukkasbhukkas"><i class="icon-twitter"></i></a></li>
                        <li><a href="https://plus.google.com/114289380283179149513/posts"><i class="icon-google"></i></a></li>
                    </ul>
    ...
    <?php echo CHtml::hiddenField('rating', isset($_GET['rating'])?$_GET['rating']:'' )?>
     ...
     <input type="submit" class="btn btn-submit" value="<?php echo Yii::t("default","Login")?>"/>
       ...
       <div class="text-left">If You don't have account ?
         <a onclick="showRegisterModel();" href="javascript:void(0);">Create Account</a>
     </div>
    </form>
