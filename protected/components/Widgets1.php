...
class Widgets extends CApplicationComponent
{
        ...
        public function searchRatingsFront()
	{
		?>
            		...
            		<div class="filter_type search-box-wrap">
						<h6>Rating <a data-toggle="collapse" href="#ratings_col" aria-expanded="false" aria-controls="ratings_col" id="filters_col_ratings"> <i class="pull-right fa fa-caret-up"></i></a></h6>
	...
	public function searchByDeliveryType()
	{
        ...
        public function searchByCuisineFront(){
            ...
            ?>
                 <div class="search-box-wrap filter_type">
                    <h6>Choose Cuisine <a href="javascript:;" id="filters_col_cu"> <i class="pull-right fa fa-caret-up"></i> <div class="clear"></div></a></h6>
                    ...
                    <div>
                     <a class="show-filter">
                          <span class="filter-text">Show All</span>
	...
	public function searchByCuisine()
	{
        ...
        public function searchMinimumOrderFront(){
           ...
           $minimum_list=array(
		  '5'=>"< ".getCurrencyCode()."100",
		  '10'=>"< ".getCurrencyCode()."250",
		  '15'=>"< ".getCurrencyCode()."500",
		  '20'=>"< ".getCurrencyCode()."1000"
		);
           ?>
 ...
 public static function searchFrontApi(){
   ...
   // $home_search_text=Yii::t("default","Find restaurants near you");
    ...
    $citys=Yii::app()->functions->getCityList();
  ...
  <form  action="<?php echo baseUrl()."/store/searchArea"?>" class="forms-search" id="forms-search" method="GET">
    <article class="clearfix m-t-120">
        <div class="col-md-4 p-lr-0 col-md-offset-1 col-sm-5">
            <div class="input-group full-width">
                ...
                <select data-validation-error-msg="You did not select city" data-validation="required" class="form-control selectpicker" data-width="100%" name="city" id="citySearchSelect">
                   <?php if(!empty($citys)):
                    ...
                    <option <?php if(strtolower($city['city']) == strtolower($currentCity)):echo"selected";endif;?> value="<?php echo $city['city'];?>"><?php echo ucwords($city['city']);?></option>
                       <?php endforeach; endif;?>
<!--                    <option value="indore" selected>Indore</option>-->
                </select>
            </div>
        </div>
        <div class="col-md-5 col-sm-6 m-tb-xs-10 p-lr-0">
<!--                    <input type="text" placeholder="Location" class="form-control custom-input">-->
            <input data-validation-error-msg="You did not enter a valid address" type="text" data-validation="required" class="form-control custom-input" name="s" id="s" placeholder="<?php echo Yii::t("default",$placholder_search)?>" value="<?php echo $kr_search_adrress;?>" />
 ...
 public function frontfeaturedMerchant(){
  ...
  public function frontfeaturedMerchantNext(){
           ...
           <?php $counts=1; foreach ($res as $val):if($counts <=3):?> 
          <?php            
           $merchant_logo=$val['merchant_logo'];
           if (empty($merchant_logo)){
           	   $merchant_logo=assetsURL()."/images/thumbnail-mini.png";
  ...
  public function frontCuisionpopular(){
      ...
      if($cuisine=Yii::app()->functions->Cuisine(true)):?>
        <?php $counts=1; $ct=0; if(!empty($cuisine)):foreach ($cuisine as $key=>$value):if($counts <= 6):?>
                 <article class="col-md-2 col-sm-4 col-xs-6 cusine-hide">
                 <aside class="pop-dish">
                     <a href="<?php echo $this->createUrl('store/searchArea',array('name'=>$value,'id'=>$key));?>">
                        <div class="thumbnail">
                        <div class="caption">
                            <h4><?php echo ucwords($value); ?></h4>
                        </div>
                        <img src="<?php echo Yii::app()->request->baseUrl;?>/assets/front/img/ad/<?php echo $imageArray[$ct];?>" alt="" class="img-responsive">
                        </div>
                     </a>
                </aside>
             </article>
...
<!--         <div class="uk-form-row">
         ...
         <div class="uk-form-row">
         <?php echo CHtml::radioButton('payment_opt',false,
         array('class'=>"icheck payment_option",'value'=>'payu'))?> <?php echo Yii::t("default","Pay Online")?>
