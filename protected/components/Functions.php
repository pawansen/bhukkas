...
class Functions extends CApplicationComponent {
    ...
    public function getCmsDetail($cms_code) {
        $DbExt = new DbExt;
        $stmt = "SELECT * FROM
                        {{cms}}
                        WHERE
    ...
    public function getFavoriteList($c_id,$m_id){
        
        $DbExt = new DbExt;
        $stmt = "SELECT merchant_id FROM
                        {{favourite}}
                        WHERE
                        merchant_id='$m_id' AND client_id = '$c_id'
                        ";
        if ($rs=$DbExt->rst($stmt)) {
        return $rs[0];
        }
    ...
    public function frontFeaturedMerchantList($list = true) {
     ...
     public function CuisineFeatured($list = true) {
        $lists[] = 'Please select';
        $lists = '';
        $DbExt = new DbExt;
        $stmt = "SELECT * FROM
    ...
    public function MerchantDeliveryOption($merchant_id = '') {
        $res = $this->getMerchant($merchant_id);
        return $res['service'];
    }
    ...
    public function merchantMenu() {
        ...
        $payment_list = array('visible' => $this->hasMerchantAccess("payment-gateway"), 'tag' => 'payment-gateway', 'label' => '<i class="fa fa-usd"></i>' . Yii::t("default", 'Payment Gateway'),
            'itemOptions' => array('class' => ''), 'items' => array(
                ...
                array('visible' => $this->hasMerchantAccess("cca"), 'tag' => 'cca', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "CCAvenue"),
                    'url' => array('merchant/ccAvenueSettings')),
        ...
        return array(
            ...
            'items' => array(
               ...
               /* array('visible' => $this->hasMerchantAccess("voucher"), 'tag' => "voucher", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Voucher"),
                ...
                array('visible' => $this->hasMerchantAccess("favouriteList"), 'tag' => "Favourite", 'label' => '<i class="fa fa-heart"></i>' . Yii::t("default", "Favourite List"),
                    'url' => array('/merchant/favouriteList')),
...
//                    'url' => array('/admin/ManageLanguage')),
                ...
                array('visible' => $this->AA('paymentgateway'), 'tag' => 'paymentgateway',
                    ...
                    'itemOptions' => array('class' => ''), 'items' => array(
                        ...
                        array('visible' => $this->AA('CcAvenueSettings'), 'tag' => 'CcAvenueSettings',
                            'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "CCAvenue"),
                            'url' => array('admin/CcAvenueSettings')),
                ...
                array('visible' => $this->AA('emailSuscriptionList'),
                    'tag' => "cmsList", 'label' => '<i class="fa fa-file-text"></i>' . Yii::t("default", "Subscribe List"),
                    'url' => array('/admin/emailSuscriptionList')),
                array('visible' => $this->AA('cmsList'),
                    'tag' => "cmsList", 'label' => '<i class="fa fa-file-text"></i>' . Yii::t("default", "CMS"),
                    'url' => array('/admin/cmsList')),
                array('visible' => $this->AA('userList'),
                    'tag' => "userList", 'label' => '<i class="fa fa-users"></i>' . Yii::t("default", "User"),
                    'url' => array('/admin/userList')),
                array('visible' => $this->AA('partnerlist'),
                    'tag' => "partnerlist", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Partner"),
                    'url' => array('/admin/partnerlist')),
                array('visible' => $this->AA('contactlist'),
                    'tag' => "contactlist", 'label' => '<i class="fa fa-phone"></i>' . Yii::t("default", "Contact Us"),
                    'url' => array('/admin/contactlist')),
                array('tag' => "logout", 'label' => '<i class="fa fa-sign-out"></i>' . Yii::t("default", "Logout"),
    ...
    public function topMenu() {
        ...
        $link_resturent = array('/store/searchArea');
        $link_aboutUs = array('/store/about');
        $link_Contacts = array('/store/contact');
        $link_Faq = array('/store/faq');
        $link_home = array('/store');

        return array(
            'activeCssClass' => 'active',
            'encodeLabel' => false,
            'items' => array(
                array('visible' => true, 'tag' => "Home", 'label' => Yii::t("default", "Home"),
                    'url' => $link_home, 'itemOptions' => array('class' => '')),
//                array('visible'=>true,'tag'=>"Restaurants",'label'=>Yii::t("default","Restaurants"),
//                'url'=>$link_resturent,'itemOptions'=>array('class'=>'')),
                array('visible' => true, 'tag' => "About us", 'label' => Yii::t("default", "About us"),
                    'url' => $link_aboutUs, 'itemOptions' => array('class' => '')),
//                array('visible'=>true,'tag'=>"Faq",'label'=>Yii::t("default","Faq"),
//                'url'=>$link_Faq,'itemOptions'=>array('class'=>'')),
                array('visible' => true, 'tag' => "Contacts", 'label' => Yii::t("default", "Contacts"),
                    'url' => $link_Contacts, 'itemOptions' => array('class' => '')),
                array('visible' => $enabled_reg, 'tag' => "home", 'label' => Yii::t("default", "Restaurant Signup"),
                    'url' => array($signup_link), 'itemOptions' => array('class' => '')),
                array('visible' => $hide, 'tag' => "Login", 'label' => Yii::t("default", "Login"),
                    'url' => 'javascript:void(0)', 'itemOptions' => array('data-toggle' => "modal", 'data-target' => "#login_2", 'class' => "top_front_sigin")),
            )
        );
    }

    public function frontTopMenu() {
        $hide = true;
        if ($this->isClientLogin()) {
            $hide = false;
        }
        ...
        return array(
            ...
            'items' => array(
                array('visible' => true, 'tag' => "Home", 'label' => Yii::t("default", "Home"),
                    'url' => $link_home, 'itemOptions' => array('class' => '')),
                array('visible' => true, 'tag' => "Restaurants", 'label' => Yii::t("default", "Restaurants"),
                    'url' => array($link_resturent)),
                array('visible' => true, 'tag' => "About us", 'label' => Yii::t("default", "About us"),
                    'url' => array($link_aboutUs)),
//                array('visible'=>true,'tag'=>"Faq",'label'=>Yii::t("default","Faq"),
//                'url'=>array($link_Faq)),
                array('visible' => true, 'tag' => "Contacts", 'label' => Yii::t("default", "Contacts"),
                    'url' => array($link_Contacts)),
                array('visible' => $hide, 'tag' => "Login", 'label' => Yii::t("default", "Login"),
                    'url' => 'javascript:void(0)', 'itemOptions' => array('data-toggle' => "modal", 'data-target' => "#login_2", 'class' => "top_sigin")),
            )
        );
    }

    public function frontBottomMenu() {
        $hide = true;
        if ($this->isClientLogin()) {
            $hide = false;
        }
...
//                array('visible' => true, 'tag' => "Faq", 'label' => Yii::t("default", "Faq"),
                    'url' => $link_Faq, 'itemOptions' => array('class' => '')),
                array('visible' => $hide, 'tag' => "Login", 'label' => Yii::t("default", "Login"),
                    'url' => '#0', 'itemOptions' => array('data-toggle' => "modal", 'data-target' => "#login_2")),
                array('visible' => $hide, 'tag' => "Register", 'label' => Yii::t("default", "Register"),
                    'url' => '#0', 'itemOptions' => array('data-toggle' => "modal", 'data-target' => "#register")),
                array('visible' => true, 'tag' => "Terms and conditions", 'label' => Yii::t("default", "Terms and conditions"),
                    'url' => $link_tac, 'itemOptions' => array('class' => '')),
            )
        );
    }
    ...
    public function getLocationAreaByCity($cid = '') {
    ...
    public function searchByRecordsCount($city = '', $state = '', $street_address = '') {
        ...
        if (isset($_POST['minimum_order']) && !empty($_POST['minimum_order'])) {
            $val = $_POST['minimum_order'];
            $and.=" AND minimum_order <= " . $val . " ";
            $query = true;
        }

        if (!empty($_GET['categorys'])) {
            if ($_GET['categorys'] != 'all') {
                $and.=" AND merchant_category = '" . $_GET['categorys'] . "'   ";
            }
        } else {
        ...
        if (isset($_POST['distance']) && !empty($_POST['distance'])) {
            ...
            $stmt = "SELECT a.*,  
                (
                 ...
                 and
                 option_name='merchant_photo' and
                 option_name='merchant_delivery_miles'
                     $and2
                 ) as merchant_logo
        ...
        if ($query) {
            if ($res_total = $DbExt->rst($stmt2)) {
                ...
                if ($count_query == true) {
                    $total_found = $res_total[0]['FOUND_ROWS()'];
                } else
                    $total_found = $res_total[0]['total_records'];
            }
            return $total_found;
        }
        return false;
    ...
    public function searchByArea1($city = '', $state = '', $street_address = '') {
    ...
    public function searchByArea12($city = '', $state = '') {
        ...
        if (isset($_GET['filter_delivery_type'])) {
            ...
            if (is_array($filter_delivery_type) && count($filter_delivery_type) >= 1) {
                ...
                if (!empty($_GET['s'])) {
                    ...
                    if (!empty($filter_delivery)) {
                        $filter_delivery = substr($filter_delivery, 0, -1);
                        $and.="service IN ($filter_delivery) AND ";
                    }
                }
            }
        }

        if (isset($_GET['city']) && !empty($_GET['city']) && !empty($_GET['s'])) {

            $search_str = explode(",", $_GET['s']);
        ...
        $filter_ratings = '';
        if (isset($_GET['filter_ratings'])) {
            $filter_rating = !empty($_GET['filter_ratings']) ? explode(",", $_GET['filter_ratings']) : false;
            if (is_array($filter_rating) && count($filter_rating) >= 1) {
                $x = 1;
                foreach ($filter_rating as $val) {
                    if (!empty($val)) {
                        if ($x == 1) {
                            $filter_ratings.="ratings=$val";
                        } else
                            $filter_ratings.=" OR ratings=$val";
                        $x++;
                    }
                }
                if (!empty($filter_ratings)) {
                    $and.=" AND  $filter_ratings ";
                }
            }
        }
...
//        exit();
    ...
    public function searchByArea($city = '', $state = '') {
        ...
        $categorys = Yii::app()->session['category'];
        $area_address = isset($_GET['s']) ? $_GET['s'] : "";
        $search_str = explode("(", $area_address);

        if (is_array($search_str) && count($search_str) >= 1) {
            $area = isset($search_str[0]) ? trim($search_str[0]) : '';
        } else {
            $area = $area_address;
        }
        $and = '';
        ...
        $filter_names = '';
        if (isset($_GET['filter_search_name']) && !empty($_GET['filter_search_name'])) {
             $filter_names = $_GET['filter_search_name'];
            ...
            if (!empty($_GET['sort_filter'])) {
                if ($_GET['sort_filter'] != "distance") {
                    if ($_GET['sort_filter'] == "minimum_order") {
                        ...
                        $sort_by = "CAST(" . $_GET['sort_filter'] . " AS SIGNED ) DESC";
                    } elseif ($_GET['sort_filter'] == "delivery_charges") {
                        $sort_by = "CAST(" . $_GET['sort_filter'] . " AS SIGNED ) ASC";
                    } else
                        $sort_by = "" . $_GET['sort_filter'] . " ASC";
                }else{
        ...
        if (isset($_GET['filter_ratings'])) {
            ...
            if (is_array($filter_rating) && count($filter_rating) >= 1) {
                ...
                foreach ($filter_rating as $val) {
                    if (!empty($val)) {
                        if ($x == 1) {
                            $filter_ratings.="CEILING(ratings)=$val";
                        } else
                            $filter_ratings.=" OR CEILING(ratings)=$val";
                        $x++;
                    }
                }
                if (!empty($filter_ratings)) {
        ...
        if (isset($_GET['restaurant-name'])) {
            ...
            $count_query = true;
             ...
             if(isset($_SESSION['currentLatLong']) && !empty($_SESSION['currentLatLong'])){
                 
                $lat = $_SESSION['currentLatLong']['lat'];
                $long = $_SESSION['currentLatLong']['long'];
    ...
    public function getItemByCategoryDishes($category_id = '', $addon = false, $merchant_id = '') {
        $DbExt = new DbExt;
        $data = '';
        $category = '%"' . $category_id . '"%';
    ...
    public function displayOrderHTML($data = '', $cart_item = '', $receipt = false, $new_order_id = '') {
        ...
        if (isset($cart_item)) {
            if (is_array($cart_item) && count($cart_item) >= 1) {
                $x = 0;
                $htm.='<div class="item-overflow">';
                $ijs=1;
                foreach ($cart_item as $key => $val) {
                    
                      $siz=""; 
                      $exp = explode('|', $val['price']);
                    ...
                    if ($receipt == false):
                        ...
                        $htm.='<a href="javascript:;" onclick="removeQtyItem(' . $val['item_id'] . ',' . $key . ',' . $mid . ',' . $val['qty'] . ',' . $val['price'] . ','.$ijs.')" class="minus_item" data-row="' . $key . '" rel="' . $val['item_id'] . '" >
    ...
    public function displayOrderApi($data = '', $cart_item = '', $receipt = false, $new_order_id = '') {
        ...
        if (isset($cart_item)) {
            if (is_array($cart_item) && count($cart_item) >= 1) {
                ...
                //shipping rates
                if (isset($data['shipping_fee']) && $data['shipping_fee'] > 1) {
                    if (is_numeric($data['shipping_fee'])) {
                        $delivery_charges = $data['shipping_fee'];
                    }
                }
                //if (isset($data['delivery_charge']) && $data['delivery_charge']>=1){
                if (isset($data['delivery_charge'])) {
                ...
                if (isset($data['voucher_code'])) {
                    if (is_array($data['voucher_code'])) {
                        ...
                        if ($data['voucher_code']['voucher_type'] == "fixed amount") {
                            ...
                            $less_voucher = $subtotal * ($data['voucher_code']['amount'] / 100);
                            $voucher_type = normalPrettyPrice($data['voucher_code']['amount']) . "%";
                        }
                        $_SESSION['less_voucher'] = $less_voucher;
                    }
                }
                ...
                $item_array_total = array(
                    ...
                    'merchant_discount_amount' => $merchant_discount_amount,
                    'merchant_packaging_charge' => $merchant_packaging_charge,
                    'less_voucher' => round($less_voucher),
                    'item_sub_total' => (isset($itemSubTotal)) ? $itemSubTotal : 0
                );
    ...
    public function getOrderApi($order_id = '',$client_id = '') {
    ...
    public function getReviewsMerchant($merchant_id = '') {
    ...
    /* public function getReviewsUser($client_id = '') {
    ...
    public function getMerchantById($merchant_id = '') {
        ...
        $DbExt = new DbExt;
        $stmt = "SELECT a.restaurant_name,a.street,a.restaurant_phone,a.city,a.state,a.post_code,a.ratings,a.cuisine,a.restaurant_slug,  
                (
                 select option_value
                 from 
                 {{option}}
                 ...
                 option_name='merchant_photo'
                    ...
                    FROM
              {{view_merchant}} a WHERE merchant_id='$merchant_id'
    ...
    public function getReviewCounts($merchant_id = '') {
    ...
    public function sendEmail($to = '', $from = '', $subject = '', $body = '', $title = '') {
    ...
    public function adminPaymentList() {
        ...
        function formatMilliseconds($second) {
            
            if(!empty($second) && ctype_digit($second)){
                $minutes = floor($second / 60);
                $hours = floor($minutes / 60);
                $minutes = $minutes % 60;

                $format = 'Opens in %uh %02umin';
        ...
        public function isMerchantOpenNowTime($mtid = '') {
            ...
            if (!empty($mtid)) {
                ...
                $stores_open_day = Yii::app()->functions->getOption("stores_open_day", $mtid);
                $stores_open_starts = Yii::app()->functions->getOption("stores_open_starts", $mtid);
                ...
                if ($stores_open_day && !empty($stores_open_starts)) {

                    if (in_array($currentDay, $stores_open_day)) {

                        if ($stores_open_starts) {

                            $openTime = strtotime($stores_open_starts[$currentDay]);

                            $openNow = $openTime - $currentTime;

                            return $this->formatMilliseconds($openNow);
                        }
                    } else {
        ...
        public function getMerchantBusinnesHours($merchant_id = '') {
            ...
            if (is_array($stores_open_day) && count($stores_open_day) >= 1) {
                ...
                $arr = array();
                $days_ar = array('mon','tue','wed','thu','fri','sat','sun');
                for($i=0;$i<=6;$i++)
                {
        ...
        public function getMerchantListOfPaymentGateway() {
			...
			";
                if ($db_ext->rst($stmt)) {
                    ...
                    $paymentgateway = array('paypal', 'stripe', 'mercadopago', 'ide', 'payu', 'pys','cca');
                }
            }
        ...
        public function addressBookList($client_id = '') {
            $list = '';
            if ($res = $this->getAddressBookByClient($client_id)) {
                return $res;
            }else{
         ...
         public function getListRecords() {
             ...
             $option = array(
                 'table' => '{{address_book}}',
                 'data'    => array('city'=>"mumbai",'state'=>"MH")
                 
             );
             $rs = $db_ext->customInsert($option);
             return $rs;
        }
