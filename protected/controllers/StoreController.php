...
class StoreController extends CController
{
	...
	public function beforeAction($action)
	{
	  ...
	  ScriptManager::RegisterAllJSFile();
		 //ScriptManager::registerAllCSSFiles();
			ScriptManager::RegisterAllFrontJSFile();
			ScriptManager::registerAllFrontCSSFiles();
			return true;
		}
		return false;
	}
	...
	public function actionIndex()
	{
            ...
            if(!isset(Yii::app()->session['myCity'])){
                ...
                if($query && $query['status'] == 'success') {
                  Yii::app()->session['myCity'] = $query['city'];
                }
           }
	...
	public function actionSignin()
	{
        ...
        function actionMerchantRegister(){
		   ...
		   Yii::app()->functions->setSEO($seo_title,$seo_meta,$seo_key);
			    ...
			    break;
                        ...
                        case 'step2':
                            ...
                            $this->render('merchant-signup-account-step3');		
			    break;
	...
	{
		$data['cmsData']=Yii::app()->functions->getCmsDetail('about_us');
		$this->render('front-aboutUs', $data);
	}
 
 	public function actionFaq()
	{
		$this->render('front-faq');
	}
	
        public function actionTac()
	{
		$data['cmsData']=Yii::app()->functions->getCmsDetail('terms_and_conditions');
		$this->render('front-terms-and-conditions' , $data);
	}
	...
	public function actionMenu()
	{
        ...
        if ( isset($data['merchant'])){
		   $re_info=Yii::app()->functions->getMerchantBySlug($data['merchant']);
                    Yii::app()->session['rest_slug'] = $data['merchant'];
                    Yii::app()->session['slug_merchant_id'] = $re_info['merchant_id'];
		} else $re_info='';
	...
	public function actionMyReviews()
	{
		 ...
		 } else $this->redirect(Yii::app()->request->baseUrl."/store");
	...
	{		
        ...
        public function actionccaInvoice(){
            $this->render('cca-invoice');
        }
        
        public function actionCheckoutCCA(){
            $this->render('ccaCheckout-payment');
        }
        
        public function actionccainit()
	{		
		$this->render('ccainit-merchant');
	}
	...
	{		
        ...
        public function actionUserInfoAccount(){
            Yii::app()->functions->getUserTableInfo();
        }
	...
	public function actionAutoPostAddress()
	{
        ...
        public function actionfavouriteRestorantList()
	{
		    $this->crumbsTitle=Yii::t("default","Favourite Restorant");
		    $this->render('favourite-restorant-list');
