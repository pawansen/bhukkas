...
class AdminController extends CController {
    ...
    public function actionIndex() {
        if (!Yii::app()->functions->isAdminLogin()) {
            ...
            if (in_array('dashboard', (array) $aa_access)) {
                ...
                $this->render('error', array('msg' => t("Sorry but you don't have access to dashboard")));
        }
    }
    ...
    public function actionViewFile() {
        ...
        if (file_exists($path_to_upload . "/" . $fileName)) {
            ...
            echo Yii::t("default", "File not found");
    }
    ...
    public function actionPayuMonenySettings() {
     ...
     public function actionCcAvenueSettings() {
        $this->crumbsTitle = Yii::t("default", "CCAvenue Settings");
        $this->render('ccavenue-settings');
    }
    ...
    public function actionPayOnDelivery() {
        ...
        if (isset($_GET['Do'])) {
            if ($_GET['Do'] == "Add") {
                ...
                $this->render('payondelivery-settings-sort');
        } else
            $this->render('payondelivery-settings');
    }
    ...
    public function actionpartnerlist() {
        $this->crumbsTitle = Yii::t("default", "Partner List");
        $this->render('merchant-contact-list');
    }

    public function actionContactlist() {
        $this->crumbsTitle = Yii::t("default", "Contact List");
        $this->render('user_contact_list');
    }
    ...
    public function actionZipCode() {
        if (getOptionA('home_search_mode') == "postcode") {
            ...
            $this->render('error', array('msg' => t("Zip code only be use if you enabled the searching to post code on settings")));
    }
    
    public function actionCmsList()
	{
		if (isset($_GET['Do'])){
			$this->crumbsTitle=Yii::t("default","CMS Add");
		    $this->render('cms-add');
		} else {
		    $this->crumbsTitle=Yii::t("default","CMS List");
		    $this->render('cms-list');
		}
	}
        
      
        
        public function actionemailSuscriptionList()
	{
		    $this->crumbsTitle=Yii::t("default","Email Subscription List");
		    $this->render('email-subscription-list');
