...
<div class="uk-form-row">
  ...
  ,array('class'=>"uk-form-width-large",'data-validation'=>"required", 'data-validation-error-msg' => "You did not enter first name."))
  ?>
</div>
...
<div class="uk-form-row">
  ...
  ,array('class'=>"uk-form-width-large",'data-validation'=>"required",'data-validation-error-msg' => "You did not enter last name.",))
  ?>
</div>
...
<div class="uk-form-row">
  ...
  ,array('class'=>"uk-form-width-large",'data-validation'=>"required",'data-validation-error-msg' => "You did not enter user name.",))
  ?>
</div>
