...
<li class="uk-active">
    <fieldset>        
        ...
        <div class="uk-form-row">
          ...
          //'data-validation-error-msg'=>"You did not enter contact phone.",
        ...
        <div class="uk-form-row">
          ...
          'data-validation-error-msg'=>"You did not enter valid contact email."    
          ))?>
        ...
        <div class="uk-form-row">
          ...
          isset($data['country_code'])?$data['country_code']:"IN",
          (array)Yii::app()->functions->CountryList(),          
          array(
          'class'=>'uk-form-width-large',
          'data-validation'=>"required",
          'data-validation-error-msg'=>"You did not enter country."    
          ))?>
        </div>
        <div class="uk-form-row">
		...
		'class'=>'uk-form-width-large',
		'data-validation'=>"required",
                'data-validation-error-msg'=>"You did not enter state/region."    
		))?>
		</div>    		
        ...
        <div class="uk-form-row">
          ...
          'multiple'=>true,
          'data-validation'=>"required",
          'data-validation-error-msg'=>"You did not enter cuisine."    
          ))?>
        </div>
        <div class="uk-form-row">
        ...
        <div class="uk-form-row">
          ...
          isset($data['status'])?(array)clientStatus():(array)clientStatusActive(),         
          array(
          'class'=>'uk-form-width-large',
          'data-validation'=>"required"
          ))?>
  ...
  'data-validation'=>"required",
  'data-validation-error-msg' => "You did not enter username."     
  ))?>
</div>
<?php  if(isset($data['password']) && $data['password'] != NULL):?>
    <div class="uk-form-row">
...
<div class="uk-form-row">
  ...
  'data-validation-error-msg' => "You did not enter password min length 6 character."  
  ))?>
</div>
<?php endif; ?>
...
<?php if(isset($data['merchant_id']) && $data['merchant_id'] != NULL): ?>
