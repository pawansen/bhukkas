...
<div class="uk-form-row">
  ...
  ,isset($_GET['id'])?array('class'=>"uk-form-width-large",'data-validation'=>"required",'readonly'=>true):array('class'=>"uk-form-width-large",'data-validation'=>"required",'data-validation-error-msg' => "You did not enter cms title.",))
  ?>
</div>
...
<div class="uk-form-row">
  ...
  ,array('class'=>"uk-form-width-large summernote",'data-validation'=>"required",'data-validation-error-msg' => "You did not enter description.",))
  ?>
</div>
