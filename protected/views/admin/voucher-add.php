...
<div class="uk-form-row">
  ...
  array(
    ...
    'data-validation-error-msg'=> "You did not enter voucher name.", 
    'class'=>"voucher_name"
  ))?>
</div>
...
<div class="uk-form-row">
  ...
  ,array('data-validation'=>'required',
         'data-validation-error-msg' => "You did not enter discount.",
         'class'=>'numeric_only'))?>
...
<div class="uk-form-row">
 ...
 'data-id'=>'expiration',
 'data-validation'=>"required",
 'data-validation-error-msg' => "You did not select expiration.",     
))
?>
</div>
