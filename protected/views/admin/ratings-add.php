...
<div class="uk-form-row">
  ...
  ,array('class'=>"uk-form-width-large numeric_only",
      'data-validation'=>"required",
      'data-validation-error-msg' => "You did not enter range 1."))
  ?>
</div>
...
<div class="uk-form-row">
  ...
  array('class'=>"uk-form-width-large numeric_only",
      'data-validation'=>"required",
       'data-validation-error-msg' => "You did not enter range 2."))
  ?>
</div>
...
<div class="uk-form-row">
  ...
  array('class'=>"uk-form-width-large",
        'data-validation'=>"required",
        'data-validation-error-msg' => "You did not enter range 3."))
  ?>
</div>
