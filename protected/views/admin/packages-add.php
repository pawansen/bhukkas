...
<div class="uk-form-row">
  ...
  'data-validation-error-msg' =>"You did not enter title."   
  ))?>
</div>
...
<div class="uk-form-row">
  ...
  'data-validation'=>"required",
  'data-validation-error-msg' => "You did not enter price."    
  ))?>
</div>
...
<div class="uk-form-row">
  ...
  'class'=>'uk-form-width-medium numeric_only',
  'data-validation'=>"required",
  'data-validation-error-msg' => "You did not enter expiration(no. of days or Year)."    
  ))?>
</div>
...
<div class="uk-form-row">
  ...
  'data-validation'=>"required",
  'data-validation-error-msg' => "You did not enter usage.",    
