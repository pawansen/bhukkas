...
<div class="uk-form-row">
 ...
 <?php echo CHtml::textField('voucher_name',$data['voucher_name'],array('data-validation'=>'required','data-validation-error-msg' => "You did not enter voucher name."))?>
</div>
...
Yii::app()->functions->voucherType(),array(
  ...
  'data-validation-error-msg' => "You did not select type."
))
?>
</div>
...
<div class="uk-form-row">
  ...
  ,array('data-validation'=>'required','data-validation-error-msg' => "You did not enter discount.",'class'=>'numeric_only'))?>
...
<div class="uk-form-row">
 ...
 'data-id'=>'expiration',
 'data-validation'=>"required",
 'data-validation-error-msg' => "You did not enter expiration."     
))
?>
</div>
