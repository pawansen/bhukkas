...
<?php if ( getOptionA('mechant_sms_enabled')=="noaccess"):?>
...
<div class="uk-form-row">
  ...
  <div class="uk-grid" >
    ...
    ,array('value'=>$key,'class'=>"icheck icheckDays"))?>
    </div>
    ...
    <div class="uk-width-1-6" style="width:12%">
      ...
      ,array('placeholder'=>Yii::t("default","Start"),'class'=>"timepick ".$key.""));?>
    </div>
    ...
    <div class="uk-width-1-6" style="width:12%">
      ...
      ,array('placeholder'=>Yii::t("default","End"),'class'=>"timepick ".$key.""));?>
    </div>
