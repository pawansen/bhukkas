...
<?php echo CHtml::textField("alert_email_receiver",yii::app()->functions->getOptionAdmin('alert_email_receiver'),
array(
'class'=>"uk-form-width-large",
'placeholder'=>Yii::t("default","Email address")
))?>
<p class="uk-alert uk-alert-danger">Note: * This email on sent all email alerts.</p>
</div>
