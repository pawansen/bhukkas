...
<div class="new-menu-wrapper menu-wrapper page-right-sidebar <?php echo $style_bg;?>">
  ...
  Yii::app()->clientScript->registerMetaTag(Yii::app()->getBaseUrl(true).'/store/menu/merchant/'.$_GET['merchant'],'og:url');      Yii::app()->clientScript->registerMetaTag(Yii::t("default",$default_share_text),'og:title'); 
