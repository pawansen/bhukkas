...
<body style="width:100%; float:left; background:rgb(127, 251, 200); font-family:arial;">
    ...
    <div class="main" style="width:900px; margin:0px auto">
        ...
        <div style="">
            <img src="<?php echo Yii::app()->request->baseUrl;?>/assets/images/1463638947-logo.png" style="margin:30px 40%" 0px;/>
        </div>
        ...
        <h4 style="margin:5px 0px">B3, B4 Khushal complex, 31,32,33 Ghafur kha ki Bajuriya, near Shubhash Chowk, Rajwada, Indore</h4>
        <h4 style="margin:5px 0px">9300068101</h4>
    </div>
</body>
