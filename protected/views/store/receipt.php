     ...
     <?php if ($ok==TRUE):?>
         ...
         <p><?php echo Yii::t("default","Your order has been placed.")?></p>
	       ...
	       <div class="input-block">
	         <div class="label-cot"><?php echo Yii::t("default","Customer Name")?> :</div>
	       ...
	       <div class="input-block">
	         <div class="label-cot"><?php echo Yii::t("default","Merchant Name")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","ABN")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","Telephone")?> :</div>
		   ...
		   <div class="input-block">
	         <div class="label-cot"><?php echo Yii::t("default","Address")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","TRN Type")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","Payment Type")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","Card#")?> :</div>
	       ...
	       ?>
	       <div class="input-block">
	         <div class="label-cot"><?php echo Yii::t("default","Paypal Transaction ID")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","Reference #")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","Payment Ref")?> :</div>
	       ...
	       <div class="input-block">
	         <div  class="label-cot"><?php echo Yii::t("default","TRN Date")?> :</div>
	       ...
	       <?php if ($data['trans_type']=="delivery"):?>
		       ...
		       <div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Delivery Date")?> :</div>
		       ...
		       <div class="input-block">
		         <div class="label-cot"><?php echo Yii::t("default","Delivery Time")?> :</div>
		       ...
		       <div class="input-block">
		         <div  ><?php echo Yii::t("default","Deliver ASAP")?> :</div>
		         <div class="value">
		       ...
		       <div class="input-block">
		         <div class="label-cot"><?php echo Yii::t("default","Deliver to")?> :</div>
		         <div class="value">
		         <?php 		         
		       ...
		       <div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Delivery Instruction")?> :</div>
		       ...
		       <div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Location Name")?> :</div>
		         <div class="value"><?php 
		       ...
		       <?php 	       
				...
				<div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Contact Number")?> :</div>
		         <div class="value"><?php 
		       ...
		       <?php 	       
				...
				<div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Change")?> :</div>
		   ...
		   <?php else :?>   
		      ...
		      <?php if (isset($_SESSION['kr_delivery_options']['delivery_date'])):?>
		       <div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Pickup Date")?> :</div>
		       ...
		       <?php if ( !empty($_SESSION['kr_delivery_options']['delivery_time'])):?>
		       <div class="input-block">
		         <div  class="label-cot"><?php echo Yii::t("default","Pickup Time")?> :</div>
		         <div class="value"><?php echo $_SESSION['kr_delivery_options']['delivery_time']?></div>
		         <div class="clear"></div>
		       </div>
		       <?php 	       
