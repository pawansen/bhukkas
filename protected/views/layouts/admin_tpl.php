...
<link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/vendor/summernote/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" />
<link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/vendor/summernote/bootstrap-wysihtml5/wysiwyg-color.css" rel="stylesheet" />
<link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/vendor/summernote/dist/summernote.css" rel="stylesheet" />
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/assets/vendor/summernote/bootstrap.min.js"></script> 
 <!--Summernote js-->
  <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/assets/vendor/summernote/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script> 
 <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/assets/vendor/summernote/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script> 
          
 <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/assets/vendor/summernote/dist/summernote.min.js"></script>

 <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/assets/vendor/bootbox.min.js"></script>
